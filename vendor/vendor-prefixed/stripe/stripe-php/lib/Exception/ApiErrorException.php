...
abstract class ApiErrorException extends \Exception implements ExceptionInterface
{
     ...
     * @param null|array|\StellarPay\Vendors\Stripe\Util\CaseInsensitiveArray $httpHeaders the HTTP headers array
     ...
     *
     * @return null|\StellarPay\Vendors\Stripe\ErrorObject
     */
     ...
     *
     * @param null|\StellarPay\Vendors\Stripe\ErrorObject $error
     */
     ...
     *
     * @return null|array|\StellarPay\Vendors\Stripe\Util\CaseInsensitiveArray
     */
     ...
     *
     * @param null|array|\StellarPay\Vendors\Stripe\Util\CaseInsensitiveArray $httpHeaders
     */
    ...
    protected function constructErrorObject()
    {
        ...
        return \StellarPay\Vendors\Stripe\ErrorObject::constructFrom($this->jsonBody['error']);
    }
}

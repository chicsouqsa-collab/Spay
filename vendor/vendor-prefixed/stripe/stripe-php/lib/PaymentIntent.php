 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $amount_details
 * @property int $amount_received Amount that this PaymentIntent collects.
 * @property null|string|\StellarPay\Vendors\Stripe\Application $application ID of the Connect application that created the PaymentIntent.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $automatic_payment_methods Settings to configure compatible payment methods from the <a href="https://dashboard.stripe.com/settings/payment_methods">Stripe Dashboard</a>
 ...
 * @property null|string|\StellarPay\Vendors\Stripe\Invoice $invoice ID of the invoice that created this PaymentIntent, if it exists.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $last_payment_error The payment error encountered in the previous PaymentIntent confirmation. It will be cleared if the PaymentIntent is later updated for any reason.
 * @property null|string|\StellarPay\Vendors\Stripe\Charge $latest_charge ID of the latest <a href="https://stripe.com/docs/api/charges">Charge object</a> created by this PaymentIntent. This property is <code>null</code> until PaymentIntent confirmation is attempted.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $next_action If present, this property tells you what actions you need to take in order for your customer to fulfill a payment using the provided source.
 * @property null|string|\StellarPay\Vendors\Stripe\Account $on_behalf_of The account (if any) for which the funds of the PaymentIntent are intended. See the PaymentIntents <a href="https://stripe.com/docs/payments/connected-accounts">use case for connected accounts</a> for details.
 * @property null|string|\StellarPay\Vendors\Stripe\PaymentMethod $payment_method ID of the payment method used in this PaymentIntent.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $payment_method_configuration_details Information about the payment method configuration used for this PaymentIntent.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $payment_method_options Payment-method-specific configuration for this PaymentIntent.
 * @property string[] $payment_method_types The list of payment method types (e.g. card) that this PaymentIntent is allowed to use.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $processing If present, this property tells you about the processing state of the payment.
 ...
 * @property null|string|\StellarPay\Vendors\Stripe\Review $review ID of the review associated with this PaymentIntent, if any.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $shipping Shipping information for this PaymentIntent.
 * @property null|string|\StellarPay\Vendors\Stripe\Account|\StellarPay\Vendors\Stripe\BankAccount|\StellarPay\Vendors\Stripe\Card|\StellarPay\Vendors\Stripe\Source $source This is a legacy field that will be removed in the future. It is the ID of the Source object that is associated with this PaymentIntent, if one was supplied.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $transfer_data The data that automatically creates a Transfer after the payment finalizes. Learn more about the <a href="https://stripe.com/docs/payments/connected-accounts">use case for connected accounts</a>.
...
class PaymentIntent extends ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\PaymentIntent the created resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\PaymentIntent> of ApiResources
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\PaymentIntent the updated resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\PaymentIntent the applied payment intent
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\PaymentIntent the canceled payment intent
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\PaymentIntent the captured payment intent
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\PaymentIntent the confirmed payment intent
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\PaymentIntent the incremented payment intent
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\PaymentIntent the verified payment intent
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\SearchResult<\Stripe\PaymentIntent> the payment intent search results
     */

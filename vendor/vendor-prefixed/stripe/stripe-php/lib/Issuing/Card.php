 ...
 * @property null|string|\StellarPay\Vendors\Stripe\Issuing\PersonalizationDesign $personalization_design The personalization design object belonging to this card.
 * @property null|string|\StellarPay\Vendors\Stripe\Issuing\Card $replaced_by The latest card that replaces this card, if any.
 * @property null|string|\StellarPay\Vendors\Stripe\Issuing\Card $replacement_for The card this card replaces, if any.
 * @property null|string $replacement_reason The reason why the previous card needed to be replaced.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $shipping Where and how the card will be shipped.
 * @property \StellarPay\Vendors\Stripe\StripeObject $spending_controls
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $wallets Information relating to digital wallets (like Apple Pay and Google Pay).
 *
 * @license MIT
 * Modified by stellarwp using {@see https://github.com/BrianHenryIE/strauss}.
 */
class Card extends \StellarPay\Vendors\Stripe\ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\Issuing\Card the created resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\Issuing\Card> of ApiResources
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Issuing\Card
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Issuing\Card the updated resource
     */

...
namespace StellarPay\Vendors\Stripe\Checkout;
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $after_expiration When set, provides configuration for actions to take if this Checkout Session expires.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $consent Results of <code>consent_collection</code> for this session.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $consent_collection When set, provides configuration for the Checkout Session to gather active consent from customers.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $currency_conversion Currency conversion details for <a href="https://docs.stripe.com/payments/checkout/adaptive-pricing">Adaptive Pricing</a> sessions
 * @property \StellarPay\Vendors\Stripe\StripeObject[] $custom_fields Collect additional information from your customer using custom fields. Up to 3 fields are supported.
 * @property \StellarPay\Vendors\Stripe\StripeObject $custom_text
 * @property null|string|\StellarPay\Vendors\Stripe\Customer $customer The ID of the customer for this Session. For Checkout Sessions in <code>subscription</code> mode or Checkout Sessions with <code>customer_creation</code> set as <code>always</code> in <code>payment</code> mode, Checkout will create a new customer object based on information provided during the payment flow unless an existing customer was provided when the Session was created.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $customer_details The customer details including the customer's tax exempt status and the customer's tax IDs. Customer's address details are not present on Sessions in <code>setup</code> mode.
 ...
 * @property null|string|\StellarPay\Vendors\Stripe\Invoice $invoice ID of the invoice created by the Checkout Session, if it exists.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $invoice_creation Details on the state of invoice creation for the Checkout Session.
 * @property null|\StellarPay\Vendors\Stripe\Collection<\Stripe\LineItem> $line_items The line items purchased by the customer.
 ...
 * @property null|string|\StellarPay\Vendors\Stripe\PaymentIntent $payment_intent The ID of the PaymentIntent for Checkout Sessions in <code>payment</code> mode. You can't confirm or cancel the PaymentIntent for a Checkout Session. To cancel, <a href="https://stripe.com/docs/api/checkout/sessions/expire">expire the Checkout Session</a> instead.
 * @property null|string|\StellarPay\Vendors\Stripe\PaymentLink $payment_link The ID of the Payment Link that created this Session.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $payment_method_configuration_details Information about the payment method configuration used for this Checkout session if using dynamic payment methods.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $payment_method_options Payment-method-specific configuration for the PaymentIntent or SetupIntent of this CheckoutSession.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $phone_number_collection
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $saved_payment_method_options Controls saved payment method settings for the session. Only available in <code>payment</code> and <code>subscription</code> mode.
 * @property null|string|\StellarPay\Vendors\Stripe\SetupIntent $setup_intent The ID of the SetupIntent for Checkout Sessions in <code>setup</code> mode. You can't confirm or cancel the SetupIntent for a Checkout Session. To cancel, <a href="https://stripe.com/docs/api/checkout/sessions/expire">expire the Checkout Session</a> instead.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $shipping_address_collection When set, provides configuration for Checkout to collect a shipping address from a customer.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $shipping_cost The details of the customer cost of shipping, including the customer chosen ShippingRate.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $shipping_details Shipping information for this Checkout Session.
 * @property \StellarPay\Vendors\Stripe\StripeObject[] $shipping_options The shipping rate options applied to this Session.
 ...
 * @property null|string|\StellarPay\Vendors\Stripe\Subscription $subscription The ID of the subscription for Checkout Sessions in <code>subscription</code> mode.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $tax_id_collection
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $total_details Tax and discount details for the computed total amount.
 ...
 */
class Session extends \StellarPay\Vendors\Stripe\ApiResource
{
    const OBJECT_NAME = 'checkout.session';

    use \StellarPay\Vendors\Stripe\ApiOperations\Update;
     ...
     *
     * @return \StellarPay\Vendors\Stripe\Checkout\Session the created resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\Checkout\Session> of ApiResources
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Checkout\Session the updated resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Checkout\Session the expired session
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\LineItem> list of line items
     */

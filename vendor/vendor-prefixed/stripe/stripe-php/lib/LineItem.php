 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject[] $discounts The discounts applied to the line item.
 * @property null|\StellarPay\Vendors\Stripe\Price $price The price used to generate the line item.
 * @property null|int $quantity The quantity of products being purchased.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject[] $taxes The taxes applied to the line item.
 *
 * @license MIT

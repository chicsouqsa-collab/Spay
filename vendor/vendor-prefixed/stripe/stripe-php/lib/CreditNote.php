 ...
 * @property string|\StellarPay\Vendors\Stripe\Customer $customer ID of the customer.
 * @property null|string|\StellarPay\Vendors\Stripe\CustomerBalanceTransaction $customer_balance_transaction Customer balance transaction related to this credit note.
 ...
 * @property \StellarPay\Vendors\Stripe\StripeObject[] $discount_amounts The aggregate amounts calculated per discount for all line items.
 ...
 * @property string|\StellarPay\Vendors\Stripe\Invoice $invoice ID of the invoice.
 * @property \StellarPay\Vendors\Stripe\Collection<\Stripe\CreditNoteLineItem> $lines Line items that make up the credit note
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject[] $pretax_credit_amounts The pretax credit amounts (ex: discount, credit grants, etc) for all line items.
 ...
 * @property null|string|\StellarPay\Vendors\Stripe\Refund $refund Refund related to this credit note.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $shipping_cost The details of the cost of shipping, including the ShippingRate applied to the invoice.
 ...
 * @property \StellarPay\Vendors\Stripe\StripeObject[] $tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class CreditNote extends ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\CreditNote the created resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\CreditNote> of ApiResources
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\CreditNote
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\CreditNote the updated resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\CreditNote the previewed credit note
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\CreditNoteLineItem> list of credit note line items
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\CreditNote the voided credit note
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\CreditNoteLineItem> the list of credit note line items
     */

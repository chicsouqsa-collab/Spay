 ...
 * @property null|string|\StellarPay\Vendors\Stripe\Account $account The ID of the account that the bank account is associated with.
 ...
 * @property null|string|\StellarPay\Vendors\Stripe\Customer $customer The ID of the customer that the bank account is associated with.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $future_requirements Information about the <a href="https://stripe.com/docs/connect/custom-accounts/future-requirements">upcoming new requirements for the bank account</a>, including what information needs to be collected, and by when.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $requirements Information about the requirements for the bank account, including what information needs to be collected.
...
class BankAccount extends ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\BankAccount the deleted resource
     */

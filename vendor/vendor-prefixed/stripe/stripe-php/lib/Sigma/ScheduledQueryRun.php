...
namespace StellarPay\Vendors\Stripe\Sigma;
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $error
 * @property null|\StellarPay\Vendors\Stripe\File $file The file object representing the results of the query.
 ...
 */
class ScheduledQueryRun extends \StellarPay\Vendors\Stripe\ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\Sigma\ScheduledQueryRun> of ApiResources
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Sigma\ScheduledQueryRun
     */

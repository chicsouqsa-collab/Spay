...
namespace StellarPay\Vendors\Stripe\Climate;
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $beneficiary
 ...
 * @property \StellarPay\Vendors\Stripe\StripeObject[] $delivery_details Details about the delivery of carbon removal for this order.
 ...
 * @property string|\StellarPay\Vendors\Stripe\Climate\Product $product Unique ID for the Climate <code>Product</code> this order is purchasing.
 ...
 */
class Order extends \StellarPay\Vendors\Stripe\ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\Climate\Order the created resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\Climate\Order> of ApiResources
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Climate\Order
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Climate\Order the updated resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Climate\Order the canceled order
     */

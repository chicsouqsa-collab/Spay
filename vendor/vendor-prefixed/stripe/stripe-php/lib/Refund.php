 ...
 * @property null|string|\StellarPay\Vendors\Stripe\Charge $charge ID of the charge that's refunded.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $destination_details
 * @property null|string|\StellarPay\Vendors\Stripe\BalanceTransaction $failure_balance_transaction After the refund fails, this balance transaction describes the adjustment made on your account balance that reverses the initial balance transaction.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $next_action
 * @property null|string|\StellarPay\Vendors\Stripe\PaymentIntent $payment_intent ID of the PaymentIntent that's refunded.
 ...
 * @property null|string|\StellarPay\Vendors\Stripe\TransferReversal $source_transfer_reversal The transfer reversal that's associated with the refund. Only present if the charge came from another Stripe account.
 ...
 * @property null|string|\StellarPay\Vendors\Stripe\TransferReversal $transfer_reversal This refers to the transfer reversal object if the accompanying transfer reverses. This is only applicable if the charge was created using the destination parameter.
 *
 * @license MIT
...
class Refund extends ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\Refund the created resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\Refund> of ApiResources
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Refund the updated resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Refund the canceled refund
     */

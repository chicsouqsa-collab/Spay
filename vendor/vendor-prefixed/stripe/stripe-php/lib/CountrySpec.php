 ...
 * @property \StellarPay\Vendors\Stripe\StripeObject $supported_bank_account_currencies Currencies that can be accepted in the specific country (for transfers).
 ...
 * @property \StellarPay\Vendors\Stripe\StripeObject $verification_fields
 *
 * @license MIT
...
class CountrySpec extends ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\CountrySpec> of ApiResources
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\CountrySpec
     */

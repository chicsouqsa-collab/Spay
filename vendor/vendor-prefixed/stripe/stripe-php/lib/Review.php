 ...
 * @property null|string|\StellarPay\Vendors\Stripe\Charge $charge The charge associated with this review.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $ip_address_location Information related to the location of the payment. Note that this information is an approximation and attempts to locate the nearest population center - it should not be used to determine a specific address.
 ...
 * @property null|string|\StellarPay\Vendors\Stripe\PaymentIntent $payment_intent The PaymentIntent ID associated with this review, if one exists.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $session Information related to the browsing session of the user who initiated the payment.
 *
 * @license MIT
...
class Review extends ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\Review> of ApiResources
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Review the approved review
     */

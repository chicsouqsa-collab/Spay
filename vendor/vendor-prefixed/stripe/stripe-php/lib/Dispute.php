 ...
 * @property \StellarPay\Vendors\Stripe\BalanceTransaction[] $balance_transactions List of zero, one, or two balance transactions that show funds withdrawn and reinstated to your Stripe account as a result of this dispute.
 * @property string|\StellarPay\Vendors\Stripe\Charge $charge ID of the charge that's disputed.
 ...
 * @property \StellarPay\Vendors\Stripe\StripeObject $evidence_details
 ...
 * @property null|string|\StellarPay\Vendors\Stripe\PaymentIntent $payment_intent ID of the PaymentIntent that's disputed.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $payment_method_details
...
class Dispute extends ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\Dispute> of ApiResources
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Dispute
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Dispute the updated resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Dispute the closed dispute
     */

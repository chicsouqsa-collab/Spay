 ...
 * @property \StellarPay\Vendors\Stripe\StripeObject $customer_acceptance
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $multi_use
 * @property null|string $on_behalf_of The account (if any) that the mandate is intended for.
 * @property string|\StellarPay\Vendors\Stripe\PaymentMethod $payment_method ID of the payment method associated with this mandate.
 * @property \StellarPay\Vendors\Stripe\StripeObject $payment_method_details
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $single_use
...
class Mandate extends ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\Mandate
     */

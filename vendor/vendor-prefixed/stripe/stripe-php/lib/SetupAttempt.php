 ...
 * @property null|string|\StellarPay\Vendors\Stripe\Application $application The value of <a href="https://stripe.com/docs/api/setup_intents/object#setup_intent_object-application">application</a> on the SetupIntent at the time of this confirmation.
 ...
 * @property null|string|\StellarPay\Vendors\Stripe\Customer $customer The value of <a href="https://stripe.com/docs/api/setup_intents/object#setup_intent_object-customer">customer</a> on the SetupIntent at the time of this confirmation.
 ...
 * @property null|string|\StellarPay\Vendors\Stripe\Account $on_behalf_of The value of <a href="https://stripe.com/docs/api/setup_intents/object#setup_intent_object-on_behalf_of">on_behalf_of</a> on the SetupIntent at the time of this confirmation.
 * @property string|\StellarPay\Vendors\Stripe\PaymentMethod $payment_method ID of the payment method used with this SetupAttempt.
 * @property \StellarPay\Vendors\Stripe\StripeObject $payment_method_details
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $setup_error The error encountered during this attempt to confirm the SetupIntent, if any.
 * @property string|\StellarPay\Vendors\Stripe\SetupIntent $setup_intent ID of the SetupIntent that this attempt belongs to.
...
class SetupAttempt extends ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\SetupAttempt> of ApiResources
     */

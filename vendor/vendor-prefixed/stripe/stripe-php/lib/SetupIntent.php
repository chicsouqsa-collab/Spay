 ...
 * @property null|string|\StellarPay\Vendors\Stripe\Application $application ID of the Connect application that created the SetupIntent.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $automatic_payment_methods Settings for dynamic payment methods compatible with this Setup Intent
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $last_setup_error The error encountered in the previous SetupIntent confirmation.
 * @property null|string|\StellarPay\Vendors\Stripe\SetupAttempt $latest_attempt The most recent SetupAttempt for this SetupIntent.
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|string|\StellarPay\Vendors\Stripe\Mandate $mandate ID of the multi use Mandate generated by the SetupIntent.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $next_action If present, this property tells you what actions you need to take in order for your customer to continue payment setup.
 * @property null|string|\StellarPay\Vendors\Stripe\Account $on_behalf_of The account (if any) for which the setup is intended.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $payment_method_configuration_details Information about the payment method configuration used for this Setup Intent.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $payment_method_options Payment method-specific configuration for this SetupIntent.
 ...
 * @property null|string|\StellarPay\Vendors\Stripe\Mandate $single_use_mandate ID of the single_use Mandate generated by the SetupIntent.
...
class SetupIntent extends ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\SetupIntent the created resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\SetupIntent> of ApiResources
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\SetupIntent the updated resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\SetupIntent the canceled setup intent
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\SetupIntent the confirmed setup intent
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\SetupIntent the verified setup intent
     */

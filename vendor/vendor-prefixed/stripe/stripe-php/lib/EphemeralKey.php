...
class EphemeralKey extends ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\EphemeralKey the deleted resource
     */
     ...
     * @param null|array|string $opts
     *
     * @throws \StellarPay\Vendors\Stripe\Exception\InvalidArgumentException if stripe_version is missing
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\EphemeralKey the created key
     */

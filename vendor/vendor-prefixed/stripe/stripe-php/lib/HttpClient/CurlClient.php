...
namespace StellarPay\Vendors\Stripe\HttpClient;

use StellarPay\Vendors\Stripe\Exception;
use StellarPay\Vendors\Stripe\Stripe;
use StellarPay\Vendors\Stripe\Util;
...
class CurlClient implements ClientInterface, StreamingClientInterface
{
    ...
    /** @var \StellarPay\Vendors\Stripe\Util\RandomGenerator */
     ...
     * @param null|\StellarPay\Vendors\Stripe\Util\RandomGenerator $randomGenerator
     */
     ...
     * @param int $errno
     * @param int $rcode
     * @param array|\StellarPay\Vendors\Stripe\Util\CaseInsensitiveArray $rheaders
     * @param int $numRetries
     *
     * @return bool
     */

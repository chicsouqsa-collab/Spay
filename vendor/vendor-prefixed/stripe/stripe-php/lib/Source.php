 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $ach_credit_transfer
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $ach_debit
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $code_verification
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $owner Information about the owner of the payment instrument that may be used or required by particular source types.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $p24
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $receiver
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $redirect
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $sepa_credit_transfer
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $source_order
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $three_d_secure
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $wechat
 *
 * @license MIT
...
class Source extends ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\Source the created resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Source
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Source the updated resource
     */
     ...
     * @param null|array|string $opts
     *
     * @throws \StellarPay\Vendors\Stripe\Exception\UnexpectedValueException if the source is not attached to a customer
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Source the detached source
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\SourceTransaction> list of source transactions
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Source the verified source
     */

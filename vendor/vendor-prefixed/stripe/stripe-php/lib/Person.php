 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $additional_tos_acceptances
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $address
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $address_kana The Kana variation of the person's address (Japan only).
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $address_kanji The Kanji variation of the person's address (Japan only).
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $dob
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $future_requirements Information about the <a href="https://stripe.com/docs/connect/custom-accounts/future-requirements">upcoming new requirements for this person</a>, including what information needs to be collected, and by when.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $registered_address
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $relationship
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $requirements Information about the requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $verification
 *
 * @license MIT
...
class Person extends ApiResource
{
     ...
     *
     * @throws \StellarPay\Vendors\Stripe\Exception\BadMethodCallException
     */

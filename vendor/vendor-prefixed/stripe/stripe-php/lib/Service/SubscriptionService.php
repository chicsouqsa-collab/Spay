 ...
 */
class SubscriptionService extends \StellarPay\Vendors\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\Subscription>
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Subscription
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\SearchResult<\Stripe\Subscription>
     */

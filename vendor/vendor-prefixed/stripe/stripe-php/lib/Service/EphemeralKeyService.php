 ...
 */
class EphemeralKeyService extends \StellarPay\Vendors\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \StellarPay\Vendors\Stripe\EphemeralKey
     */
    ...
    public function create($params = null, $opts = null)
    {
        if (!$opts || !isset($opts['stripe_version'])) {
            throw new \StellarPay\Vendors\Stripe\Exception\InvalidArgumentException('stripe_version must be specified to create an ephemeral key');
        }

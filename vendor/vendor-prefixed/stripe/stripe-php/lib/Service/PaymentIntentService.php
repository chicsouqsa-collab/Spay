 ...
 */
class PaymentIntentService extends \StellarPay\Vendors\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\PaymentIntent>
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\PaymentIntent
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\SearchResult<\Stripe\PaymentIntent>
     */

...
namespace StellarPay\Vendors\Stripe\Reporting;
 ...
 * @property \StellarPay\Vendors\Stripe\StripeObject $parameters
 ...
 * @property null|\StellarPay\Vendors\Stripe\File $result The file object representing the result of the report run (populated when <code>status=succeeded</code>).
 ...
 */
class ReportRun extends \StellarPay\Vendors\Stripe\ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\Reporting\ReportRun the created resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\Reporting\ReportRun> of ApiResources
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Reporting\ReportRun
     */

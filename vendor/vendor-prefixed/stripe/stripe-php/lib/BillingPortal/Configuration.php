...
namespace StellarPay\Vendors\Stripe\BillingPortal;
 ...
 * @property null|string|\StellarPay\Vendors\Stripe\Application $application ID of the Connect Application that created the configuration.
 * @property \StellarPay\Vendors\Stripe\StripeObject $business_profile
 ...
 * @property \StellarPay\Vendors\Stripe\StripeObject $features
 ...
 * @property \StellarPay\Vendors\Stripe\StripeObject $login_page
 ...
 */
class Configuration extends \StellarPay\Vendors\Stripe\ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\BillingPortal\Configuration the created resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\BillingPortal\Configuration> of ApiResources
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\BillingPortal\Configuration
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\BillingPortal\Configuration the updated resource
     */

 ...
 * @property \StellarPay\Vendors\Stripe\StripeObject $customer_mapping
 * @property \StellarPay\Vendors\Stripe\StripeObject $default_aggregation
 ...
 * @property \StellarPay\Vendors\Stripe\StripeObject $value_settings
 *
 * @license MIT
 * Modified by stellarwp using {@see https://github.com/BrianHenryIE/strauss}.
 */
class Meter extends \StellarPay\Vendors\Stripe\ApiResource
{
    const OBJECT_NAME = 'billing.meter';

    use \StellarPay\Vendors\Stripe\ApiOperations\NestedResource;
     ...
     *
     * @return \StellarPay\Vendors\Stripe\Billing\Meter the created resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\Billing\Meter> of ApiResources
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Billing\Meter the updated resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Billing\Meter the deactivated meter
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Billing\Meter the reactivated meter
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\Billing\MeterEventSummary> the list of meter event summaries
     */

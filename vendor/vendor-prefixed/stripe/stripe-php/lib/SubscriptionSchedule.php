 ...
 * @property null|string|\StellarPay\Vendors\Stripe\Application $application ID of the Connect Application that created the schedule.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $current_phase Object representing the start and end dates for the current phase of the subscription schedule, if it is <code>active</code>.
 * @property string|\StellarPay\Vendors\Stripe\Customer $customer ID of the customer who owns the subscription schedule.
 * @property \StellarPay\Vendors\Stripe\StripeObject $default_settings
 ...
 * @property \StellarPay\Vendors\Stripe\StripeObject[] $phases Configuration for the subscription schedule's phases.
 ...
 * @property null|string|\StellarPay\Vendors\Stripe\Subscription $subscription ID of the subscription managed by the subscription schedule.
 * @property null|string|\StellarPay\Vendors\Stripe\TestHelpers\TestClock $test_clock ID of the test clock this subscription schedule belongs to.
 *
 * @license MIT
...
class SubscriptionSchedule extends ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\SubscriptionSchedule the created resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\SubscriptionSchedule> of ApiResources
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\SubscriptionSchedule
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\SubscriptionSchedule the updated resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\SubscriptionSchedule the canceled subscription schedule
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\SubscriptionSchedule the released subscription schedule
     */

...
namespace StellarPay\Vendors\Stripe\Identity;
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $last_error If present, this property tells you the last error encountered when processing the verification.
 * @property null|string|\StellarPay\Vendors\Stripe\Identity\VerificationReport $last_verification_report ID of the most recent VerificationReport. <a href="https://stripe.com/docs/identity/verification-sessions#results">Learn more about accessing detailed verification results.</a>
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $options A set of options for the session’s verification checks.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $provided_details Details provided about the user being verified. These details may be shown to the user.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $redaction Redaction status of this VerificationSession. If the VerificationSession is not redacted, this field will be null.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $verified_outputs The user’s verified data.
 *
 * @license MIT
 * Modified by stellarwp using {@see https://github.com/BrianHenryIE/strauss}.
 */
class VerificationSession extends \StellarPay\Vendors\Stripe\ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\Identity\VerificationSession the created resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\Identity\VerificationSession> of ApiResources
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Identity\VerificationSession
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Identity\VerificationSession the updated resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Identity\VerificationSession the canceled verification session
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Identity\VerificationSession the redacted verification session
     */

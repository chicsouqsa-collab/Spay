 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $document Result from a document check
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $email Result from a email check
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $id_number Result from an id_number check
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $options
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $phone Result from a phone check
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $selfie Result from a selfie check
 ...
 */
class VerificationReport extends \StellarPay\Vendors\Stripe\ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\Identity\VerificationReport> of ApiResources
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Identity\VerificationReport
     */

 ...
 * @property null|\StellarPay\Vendors\Stripe\Collection<\Stripe\Tax\CalculationLineItem> $line_items The list of items the customer is purchasing.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $shipping_cost The shipping cost details for the calculation.
 ...
 * @property \StellarPay\Vendors\Stripe\StripeObject[] $tax_breakdown Breakdown of individual tax amounts that add up to the total.
 ...
 */
class Calculation extends \StellarPay\Vendors\Stripe\ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\Tax\Calculation the created resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\Tax\CalculationLineItem> list of calculation line items
     */

...
namespace StellarPay\Vendors\Stripe\Tax;
 ...
 * @property \StellarPay\Vendors\Stripe\StripeObject $customer_details
 * @property null|\StellarPay\Vendors\Stripe\Collection<\Stripe\Tax\TransactionLineItem> $line_items The tax collected or refunded, by line item.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $reversal If <code>type=reversal</code>, contains information about what was reversed.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $ship_from_details The details of the ship from location, such as the address.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $shipping_cost The shipping cost details for the transaction.
...
class Transaction extends \StellarPay\Vendors\Stripe\ApiResource
{
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Tax\Transaction the created transaction
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\Tax\TransactionLineItem> list of transaction line items
     */

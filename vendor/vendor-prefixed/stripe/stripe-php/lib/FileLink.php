 ...
 * @property string|\StellarPay\Vendors\Stripe\File $file The file object this link points to.
...
class FileLink extends ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\FileLink the created resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\FileLink> of ApiResources
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\FileLink
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\FileLink the updated resource
     */

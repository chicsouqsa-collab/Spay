 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $account_holder The account holder that this account belongs to.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $balance The most recent information about the account's balance.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $balance_refresh The state of the most recent attempt to refresh the account balance.
 ...
 * @property null|string|\StellarPay\Vendors\Stripe\FinancialConnections\AccountOwnership $ownership The most recent information about the account's owners.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $ownership_refresh The state of the most recent attempt to refresh the account owners.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $transaction_refresh The state of the most recent attempt to refresh the account transactions.
 *
 * @license MIT
 * Modified by stellarwp using {@see https://github.com/BrianHenryIE/strauss}.
 */
class Account extends \StellarPay\Vendors\Stripe\ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\FinancialConnections\Account> of ApiResources
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\FinancialConnections\Account
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\FinancialConnections\Account the disconnected account
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\FinancialConnections\AccountOwner> list of account owners
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\FinancialConnections\Account the refreshed account
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\FinancialConnections\Account the subscribed account
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\FinancialConnections\Account the unsubscribed account
     */

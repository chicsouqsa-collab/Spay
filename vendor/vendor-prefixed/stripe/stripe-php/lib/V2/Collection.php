 ...
 */
class Collection extends \StellarPay\Vendors\Stripe\StripeObject implements \Countable, \IteratorAggregate
{
    const OBJECT_NAME = 'list';

    use \StellarPay\Vendors\Stripe\ApiOperations\Request;
    ...
    {
        return \StellarPay\Vendors\Stripe\Stripe::$apiBase;
    }
    ...
    /**
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException
     *
    ...
    public function autoPagingIterator()
    {
        ...
        while (true) {
            ...
            $obj = \StellarPay\Vendors\Stripe\Util\Util::convertToStripeObject($response, $opts, 'v2');

...
namespace StellarPay\Vendors\Stripe\V2\Billing;
 ...
 * @property \StellarPay\Vendors\Stripe\StripeObject $payload The payload of the event. This must contain the fields corresponding to a meter’s <code>customer_mapping.event_payload_key</code> (default is <code>stripe_customer_id</code>) and <code>value_settings.event_payload_key</code> (default is <code>value</code>). Read more about the payload.

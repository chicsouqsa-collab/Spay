 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $amazon_eventbridge Amazon EventBridge configuration.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $metadata Metadata.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $status_details Additional information about event destination status.
 * @property string $type Event destination type.
 * @property int $updated Time at which the object was last updated.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $webhook_endpoint Webhook endpoint configuration.
 *
 * @license MIT
 * Modified by stellarwp using {@see https://github.com/BrianHenryIE/strauss}.
 */
class EventDestination extends \StellarPay\Vendors\Stripe\ApiResource
{

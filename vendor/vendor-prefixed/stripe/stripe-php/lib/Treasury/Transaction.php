 ...
 * @property \StellarPay\Vendors\Stripe\StripeObject $balance_impact Change to a FinancialAccount's balance
 ...
 * @property null|\StellarPay\Vendors\Stripe\Collection<\Stripe\Treasury\TransactionEntry> $entries A list of TransactionEntries that are part of this Transaction. This cannot be expanded in any list endpoints.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $flow_details Details of the flow that created the Transaction.
...
class Transaction extends \StellarPay\Vendors\Stripe\ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\Treasury\Transaction> of ApiResources
     */

 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $failure_details Details about this InboundTransfer's failure. Only set when status is <code>failed</code>.
 ...
 * @property \StellarPay\Vendors\Stripe\StripeObject $linked_flows
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $origin_payment_method_details Details about the PaymentMethod for an InboundTransfer.
 ...
 * @property null|string|\StellarPay\Vendors\Stripe\Treasury\Transaction $transaction The Transaction associated with this object.
 *
 * Modified by stellarwp using {@see https://github.com/BrianHenryIE/strauss}.
 */
class InboundTransfer extends \StellarPay\Vendors\Stripe\ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\Treasury\InboundTransfer the created resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\Treasury\InboundTransfer> of ApiResources
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Treasury\InboundTransfer
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Treasury\InboundTransfer the canceled inbound transfer
     */

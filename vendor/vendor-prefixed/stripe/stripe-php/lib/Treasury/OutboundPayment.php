 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $destination_payment_method_details Details about the PaymentMethod for an OutboundPayment.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $end_user_details Details about the end user.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $returned_details Details about a returned OutboundPayment. Only set when the status is <code>returned</code>.
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $tracking_details Details about network-specific tracking information if available.
 * @property string|\StellarPay\Vendors\Stripe\Treasury\Transaction $transaction The Transaction associated with this object.
 *
 * Modified by stellarwp using {@see https://github.com/BrianHenryIE/strauss}.
 */
class OutboundPayment extends \StellarPay\Vendors\Stripe\ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\Treasury\OutboundPayment the created resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\Treasury\OutboundPayment> of ApiResources
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Treasury\OutboundPayment
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Treasury\OutboundPayment the canceled outbound payment
     */

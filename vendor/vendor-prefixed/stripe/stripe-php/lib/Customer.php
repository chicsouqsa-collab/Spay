 ...
 * @property null|string|\StellarPay\Vendors\Stripe\Account|\StellarPay\Vendors\Stripe\BankAccount|\StellarPay\Vendors\Stripe\Card|\StellarPay\Vendors\Stripe\Source $default_source <p>ID of the default payment source for the customer.</p><p>If you use payment methods created through the PaymentMethods API, see the <a href="https://stripe.com/docs/api/customers/object#customer_object-invoice_settings-default_payment_method">invoice_settings.default_payment_method</a> field instead.</p>
 ...
 * @property null|\StellarPay\Vendors\Stripe\Discount $discount Describes the current discount active on the customer, if there is one.
 * @property null|string $email The customer's email address.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $invoice_credit_balance The current multi-currency balances, if any, that's stored on the customer. If positive in a currency, the customer has a credit to apply to their next invoice denominated in that currency. If negative, the customer has an amount owed that's added to their next invoice denominated in that currency. These balances don't apply to unpaid invoices. They solely track amounts that Stripe hasn't successfully applied to any invoice. Stripe only applies a balance in a specific currency to an invoice after that invoice (which is in the same currency) finalizes.
 * @property null|string $invoice_prefix The prefix for the customer used to generate unique invoice numbers.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $invoice_settings
 ...
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $shipping Mailing and shipping address for the customer. Appears on invoices emailed to this customer.
 * @property null|\StellarPay\Vendors\Stripe\Collection<\Stripe\Account|\StellarPay\Vendors\Stripe\BankAccount|\StellarPay\Vendors\Stripe\Card|\StellarPay\Vendors\Stripe\Source> $sources The customer's payment sources, if any.
 * @property null|\StellarPay\Vendors\Stripe\Collection<\Stripe\Subscription> $subscriptions The customer's current subscriptions, if any.
 * @property null|\StellarPay\Vendors\Stripe\StripeObject $tax
 ...
 * @property null|\StellarPay\Vendors\Stripe\Collection<\Stripe\TaxId> $tax_ids The customer's tax IDs.
 * @property null|string|\StellarPay\Vendors\Stripe\TestHelpers\TestClock $test_clock ID of the test clock that this customer belongs to.
 *
 * @license MIT
...
class Customer extends ApiResource
{
     ...
     *
     * @return \StellarPay\Vendors\Stripe\Customer the created resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Customer the deleted resource
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\Customer> of ApiResources
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Customer
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Customer the updated resource
     */
     ...
     * @param null|array|string $opts
     *
     * @return \StellarPay\Vendors\Stripe\Customer the updated customer
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\PaymentMethod> list of payment methods
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\PaymentMethod the retrieved payment method
     */
    public function retrievePaymentMethod($payment_method, $params = null, $opts = null)
    {
        ...
        $obj = \StellarPay\Vendors\Stripe\Util\Util::convertToStripeObject($response, $opts);
        $obj->setLastResponse($response);
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\SearchResult<\Stripe\Customer> the customer search results
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\CustomerBalanceTransaction> the list of customer balance transactions
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\CustomerBalanceTransaction
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\CustomerCashBalanceTransaction> the list of customer cash balance transactions
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\BankAccount|\StellarPay\Vendors\Stripe\Card|\StellarPay\Vendors\Stripe\Source> the list of payment sources (BankAccount, Card or Source)
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\BankAccount|\StellarPay\Vendors\Stripe\Card|\StellarPay\Vendors\Stripe\Source
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\CashBalance
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\Collection<\Stripe\TaxId> the list of tax ids
     */
     ...
     * @throws \StellarPay\Vendors\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarPay\Vendors\Stripe\TaxId
     */

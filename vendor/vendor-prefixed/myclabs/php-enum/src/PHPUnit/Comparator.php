...
namespace StellarPay\Vendors\MyCLabs\Enum\PHPUnit;

use StellarPay\Vendors\MyCLabs\Enum\Enum;
 ...
 *
 * \SebastianBergmann\Comparator\Factory::getInstance()->register(new \StellarPay\Vendors\MyCLabs\Enum\PHPUnit\Comparator());
 */

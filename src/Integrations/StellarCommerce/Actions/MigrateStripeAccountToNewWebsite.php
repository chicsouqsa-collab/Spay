...
/**
 * This class helps to migrate an existing connected stripe account on gateway server without re-onboarding.
 *
 ...
 * @since 1.2.0
 */
class MigrateStripeAccountToNewWebsite
{
    use RemoteHelpers;
    ...
    public function __invoke(PaymentGatewayMode $paymentGatewayMode): bool
    {
        ...
        $requestURL = add_query_arg(
            ...
            $this->client->getUrl() . '/stripe/migrate'
        );
